...
SECRET_KEY = 'django-insecure-q65pj2b_kiy=qe$1z+iksxg#g(@vyhgo@de*2dhd2)@nb(_3q&'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Note the plural "STATICFILES_DIRS"
STATIC_ROOT = os.path.join(BASE_DIR, 'assets')  # For collected static files

# Media files (user-uploaded content)
MEDIA_URL = '/media/'  # Ensure this has a leading and trailing slash
